...
Снимки "Кассини" доступны в библиотеке NASA, а я хочу обратить ваше внимание на [другое API](https://epic.gsfc.nasa.gov/about/api): на расстоянии в полтора миллиона киллометров (точка Лагранжа L1 системы Земля-Солнце) с 2015 года есть спутник-обсерватория "DSCOVR" (Deep Space Climate Observatory). Новые полноцветные фотографии полного диска Земли там появляются по нескольку раз в день, а история доступна за несколько лет (фото в размере 2048x2048 точек) . Для своего [короткого видео](https://disk.yandex.ru/i/X8ihYlEdb6dItw) я склеил данные за 10 дней.
