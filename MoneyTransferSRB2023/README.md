...
Участники истории:
1. Закрылся [Pexpay](https://www.pexpay.com/en) - биржа-посредник для обмена рублей на crypto-валюту, но вместо него есть другой посредник - [bybit](https://www.bybit.com/en-US/)
