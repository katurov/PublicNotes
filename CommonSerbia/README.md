...
1. Сделал табличку по Белграду ["Где поесть и попить"](https://docs.google.com/spreadsheets/d/1t_3RsxL-eRH5kTqMl_QjdIJJrjZJaE6oCikJun-_h7U/edit?usp=sharing), сравнивая данные из "Мишлена" и "Декантера". Удобно примерно прикинуть, где будет вкусно. Проверял в феврале 2024 ресторан Pinot - было отлично
2. (en)[Savour Serbia: 15 exciting wines to seek out](https://www.decanter.com/sponsored/savour-serbia-15-exciting-wines-to-seek-out-502843/) - рекомендация Decanter совместо с National Tourism Organization of Serbia, Association of Winemakers and Winegrowers of Serbia and Vino & Fino magazine.
3. [Nepušački lokali u Beogradu (Nonsmoking bars&restaurants in Belgrade)](https://www.google.com/maps/d/viewer?mid=1qkPRUNRiCqA-uFugbcuVy9INXgw&usp=sharing) если ищите места для обеда, но чтобы не курили (карта из 2020 года, но с тех пор мест только больше).
